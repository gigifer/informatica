  ...
  <html lang="en">
    ...
    <body>
      ...
      <article class="col-sm-12 col-md-6 col-lg-6 producto">
        <img src="img/notebook1.jpg" alt="">
        <h2>Notebook Acer</h2>
        <p>
          Notebook 14-cm0045la Amd A4 Ram 4gb Dd 64gb Radeon R3 W10
    ...
    <article class="col-sm-12 col-md-6 col-lg-6 producto">
      ...
      <h2>Notebook CX</h2>
      <p>
        • Pantalla: 11.6” - Formato 16:9
        • Procesador: Intel Atom x5 - Z8350 1.44 Ghz
        • Memoria RAM: 2GB DDR3L
        • Almacenamiento: 32GB
        • Gráficos: Gen8 - LP10 / 12E Up to 600MHz
        • Puertos: Mini HDMI Type C 1.4 / x 1 USB 3.0 / x1 USB 2.0 Soporta SDHC / SDXC
