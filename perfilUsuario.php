  ...
  <html lang="en">
    ...
    <body>
      ...
      <div class="contenedorCarro row">
        <div class="fuenteCarro font-size-2 col-sm-12 col-md-6 col-lg-6">
          <h2>
            Nombre  y Apellido
          </h2>
        </div>
        <div class="col-ms-12 col-md-3 col-lg-3 mensajes fuenteCarro font-size-1 font-color-black">
          <a style="color:black;" href="#">Mensajes</a>
        </div>
        <div class="col-ms-12 col-md-3 col-lg-3 fuenteCarro font-size-1">
          <a style="color:black;" href="#">Mis compras</a>
        </div>
      </div>
